"""
Django settings for oauth_login project.
...
SECRET_KEY = "django-insecure-=7ikexul4(z$^a(*q@$5rt7t22aggx#q(6l($zqljhb)v4**q$"
...
INSTALLED_APPS = [
    ...
    "oauth2_provider",
    "rest_framework",
    "login.apps.LoginConfig",  # this is the app we created
]
...
WSGI_APPLICATION = "oauth_login.wsgi.application"
